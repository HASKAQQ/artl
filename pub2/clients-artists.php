...
<body>
    ...
    <main class="qna-section" style="background:#416d92; min-height:calc(100vh - 80px); padding-top: 36px;">
        <div class="container pb-4 pb-md-5">
            ...
            <section class="bg-white rounded-3 p-4 p-md-5 mb-4">
                ...
                <ul class="mb-0" style="line-height:1.65;">
                    ...
                    <li>Связаться с художником можно через соцсети и контакты, которые он указал в своём профиле.</li>
                </ul>
            </section>
            ...
            <section class="bg-white rounded-3 p-4 p-md-5 mb-4">
                ...
                <ul class="mb-0" style="line-height:1.65;">
                    ...
                    <li>Связаться с заказчиком можно через соцсеть/контакты, которые он прикрепил в профиле.</li>
                </ul>
            </section>
